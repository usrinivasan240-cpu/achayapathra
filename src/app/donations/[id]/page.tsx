            ...
            <Card>
              ...
              <CardHeader className={donation.imageURL ? 'pt-6' : ''}>
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={
                      donation.status === 'Available' ? 'default' : 'secondary'
                    }
                  >
                    {donation.status}
                  </Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {donation.foodType || 'Not specified'}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {cookedTime ? cookedTime.toLocaleTimeString() : 'N/A'}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {expiryTime ? expiryTime.toLocaleDateString() : 'N/A'}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <Avatar className="h-12 w-12">
                      ...
                      <AvatarFallback>
                        {donation.donor?.name?.substring(0, 2) || 'U'}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <Button variant="link" asChild className="p-0 h-auto">
                      <Link
                        href={getDirectionsUrl(donation)}
                        target="_blank"
